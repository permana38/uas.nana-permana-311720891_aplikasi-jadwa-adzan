...
public class RecyclerViewAdapter1 extends RecyclerView.Adapter<RecyclerViewAdapter1.ViewHolder> {
    ...
    public RecyclerViewAdapter1(ArrayList<String> fotorumahsakit, ArrayList<String> namarumahsakit,ArrayList<String> namakota, ArrayList<String> info, Context context) {
